...
import com.processisolation.rosera.p1_aad.DataHandler.Media;
import com.processisolation.rosera.p1_aad.Util.GridAutofitLayoutManager;
...
//                setSortMovieAPI(true);
    ...
    private void setupRecyclerView(@NonNull RecyclerView recyclerView) {
        // Todo: Amend GridLayoutManager to autosize grid
        recyclerView.setLayoutManager(new GridAutofitLayoutManager(getApplicationContext(), 342));
